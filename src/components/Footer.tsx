    ...
    <footer className="bg-black text-white py-12 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center mb-8">
          {/* Logo/Marca */}
          <div>
            <h3 className="text-2xl font-bold text-red-600 mb-2">THE KLAN</h3>
            <p className="text-gray-400 text-sm">Jiu Jitsu Brasileño en CDMX</p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-center text-gray-500 text-sm">
            © {new Date().getFullYear()} The Klan BJJ. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
